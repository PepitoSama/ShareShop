...
public class ListManager {
    ...
    /**
     * Return, if created the ListManager instance. Else, instantiate
     * ListManager and return it.
     *
     * @return ListManager
     */
    ...
    public List<GeneralProduct> getSuggest(Group g) {
	GroupDAO dao = (GroupDAO) AbstractDAOFactory.getInstance().getGroupDAO();
	g.setSuggestList(dao.getSuggest(g));
	return g.getSuggestList();
    }
