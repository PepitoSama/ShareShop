...
public class ShareShopFacade {
     ...
     * @param passwordC The password confirmation
     ...
     *
     * @param id the id of the user
     * @param dd the start date
     * @param df the end date
    ...
    /**
     * @return the number of stats entries in the database. Can be used in to
     * adjust the scale in a graph in the ui
     */
     ...
     *
     * @param userGroupList the UserGroup list
    ...
    /**
     * Set the currently selected group as the selected group in the
     * messageManager
     */
     ...
     *
     * @param text The String containing the text of the message
     ...
     *
     * @param selectedProducts A list containing the products to add
    ...
    /**
     * Transfert the product from the Shopping List to the Bought Products List
     * with the specified price
     *
     * @param p The product to transfer
     * @param price The price of the product when it was bought
     */
     ...
     *
     * @param p The product to increase
     */
     ...
     *
     * @param p The product to decrease
     */
     ...
     * @return the list
     */
    public List<GeneralProduct> getSuggest() {
	return this.listManager.getSuggest(this.groupManager.getSelected());
    }
